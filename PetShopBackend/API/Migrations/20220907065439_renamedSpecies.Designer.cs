...
namespace API.Migrations
{
    ...
    [Migration("20220907065439_renamedSpecies")]
    partial class renamedSpecies
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Data.Model.Order", b =>
                {
                    ...
                    b.Property<string>("OrderedAnimalName")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("API.Data.Model.Order", b =>
                {
                    b.HasOne("API.Data.Model.Customer", "customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("API.Data.Model.Customer", b =>
                {
                    b.HasOne("API.Data.Model.DeliveryAdress", "Address")
                        .WithMany()
